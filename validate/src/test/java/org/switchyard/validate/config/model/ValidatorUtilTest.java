    ...
    public static class TestValidator extends BaseValidator {
        ...
        public ValidationResult validate(Object obj) {
            if (obj instanceof Object) {
                ...
                return ValidatorUtil.invalidResult("not Object");
            }
        }
        ...
        public ValidationResult validateB(B b) {
            if (b instanceof B) {
                ...
                return ValidatorUtil.invalidResult("b is not B");
            }
        }
        ...
        public ValidationResult validateX(String x) {
            if (x.equals("X")) {
                ...
                return ValidatorUtil.invalidResult("x is not 'X'");
            }
        }
        ...
        public ValidationResult validateZ(B z) {
            if (z instanceof B) {
                ...
                return ValidatorUtil.invalidResult("z is not B");
            }
        }
